...
object CodeStyles {
    ...
    private val AUTO_LIGHT = CodeStyle(
        "auto", "跟随",
        bg = 0xFFF6F6F4.toInt(), fg = 0xFF24292E.toInt(),
        keyword = 0xFFCF222E.toInt(), string = 0xFF0A8754.toInt(),
        comment = 0xFF8A8F98.toInt(), number = 0xFF0550AE.toInt(), type = 0xFF953800.toInt()
    )
    ...
    private val GITHUB = CodeStyle(
        ...
        comment = 0xFF6A737D.toInt(), number = 0xFF005CC5.toInt(), type = 0xFF6F42C1.toInt()
    )
